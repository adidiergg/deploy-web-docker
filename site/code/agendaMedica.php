...
<head>
    ...
    <title>Medico | Agenda medica</title>
            ...
            <div class="calendar">
                <div class="header">
                    ...
                    <div class="justify-content-center col-md-12" style="display: flex; align-items: center">
                        <h2 style="flex: 1; text-align:center;">Próximas citas</h2>
                    </div> 
                    <div style="align-self: flex-start; flex: 0 0 1"></div>
                </div>
            <div class="outer">
                ...
                <div class="wrap">
                    <table class="offset">
                        <tbody>
                            ...
                            ?>
                            <td class="headcol">
                            <?php echo $h; ?>:<?php if($m==0){ echo 0; } echo $m ?></td>
                            <?php
                                for ($d = 0; $d <= 4; $d++){
                                    list($valores, $num_rows) = $citas->search_agenda($d, $h, $m);
                                    if ($num_rows > 0) {
                                        foreach($valores as $items){ 
                                    ?>
                                    <td onclick="window.location='<?php echo "expediente.php?username=".$items['CURP_paciente'] ?>'">
                                        <?php 
                                        $Cpac = $items['CURP_paciente'];
                                        $query = $paciente->search_registro($Cpac);
                                        foreach($query as $items2){
                                            echo $items2['Nombre'].' '.$items2['Last_name'];
                                        }
                                        ?>
                                    </td>
                            <?php
                            ...
                            <?php
                                for ($i = 9; $i <= 18; $i++) {
                            ?>
                                    <tr><?php search($i, 0);?></tr>
                                    <tr><?php search($i, 20);?></tr>
                                    <tr><?php if($i != 18){search($i, 40);}?></tr>
                            <?php 
                                }
                            ?>
                        </tbody>
