<?php
    require_once("php/expediente.php");// el include es para llamar a un archivo
    require_once("php/diagnostico.php");
    ...
    $resultado = $expediente->new_expediente($username);
    $Num_expediente = $resultado[0]['Num_expediente'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="agendaMedica.php">Agenda medica</a>
                        </li>
                        <li class="nav-item">
    ...
    <section>
        <div class="container mt-5 mb-5">
            ...
            <div class="form-row justify-content-center">
                <div class="form-group col-md-12">
                    <br>
                    <h3 style="text-align: center;"><?php echo $resultado[0]['Nombre_paciente'].' '.$resultado[0]['Last_name']; ?></h3>
                    <h4 style="text-align: center; color: teal;"><?php echo $resultado[0]['CURP']; ?></h4><br>
                    <p style="text-align:center; font-size: 1.1rem;">
                    <?php echo 'Dirección: '.$resultado[0]['Domicilio_paciente'].'<br>Teléfono: '.$resultado[0]['Telefono_contacto'].'<br>Sexo: '.$resultado[0]['Sexo'].' Edad: '.$resultado[0]['Edad']; ?></p>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" style="color: black;" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form name="diagnostico" method="post" action="<?php echo "php/AgregarDiagnostico.php?username=".$username."&num=".$Num_expediente?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="observacion" class="form-control" id="padecimiento" placeholder="Especificación" required></textarea>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="reset" class="btn btn-secondary" data-bs-dismiss="modal">Salir</button>
    ...
    <section>
        <div id="ofset" class="container mt-5 mb-5 table-responsive">
            <?php
            $consult = $diagnosticos->search_registro($Num_expediente);
            if ($consult) {
            ?>
            <table class="table table-hover text-center table-striped table-light">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:center; font-size: 1.1rem;"><?php echo $fila['Nombre_medico'].' '.$fila['Last_name'];?></td>
                            <td style="text-align:center; font-size: 1.1rem;"><?php echo $fila['Observacion']?></td>
                            <td><?php echo "<a class='btn btn-info' href='modificarDiagnostico.php?id=$ID&num=$Num_expediente&username=$username'><i class='fa-solid fa-pen-to-square sizeSimbol'></i></a>" ?></td>
                            <td><?php echo "<a class='btn btn-danger' href='php/deleteDiagnostico.php?id=$ID&username=$username'><i class='fa-solid fa-delete-left sizeSimbol'></i></a>" ?></td>
                        </tr>
                    <?php
                        }
                    ?>
            ...
            ?>
                <div class="alert alert-danger d-flex align-items-center" role="alert">
                    ...
                    <div>
                        No se encuentran diagnósticos aún.
                    </div>
                </div>
            <?php
            }
    ...
    <section>
        <div class="container mt-5 mb-5">
            <div class="d-flex">
                <form class="col-md-3 me-2" action="agendaMedica.php">
                    <button class="btn btn-primary col-md-12" value="Volver">
                        Regresar a agenda
                    </button>
                </form>
                <!-- Boton para imprimir -->
                <button type="button" class="btn btn-danger col-md-3" id="btPrint" onclick="createPDF()">
                    Imprimir
                </button>
            </div>
        </div>
