                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item active" href="altasRecepcionista.php">Agregar recepcionista</a></li>
                                <li><hr class="dropdown-divider"></li>
    ...
    <section class="container mt-5 mb-5">
        <div class="row g-5 mt-5" style="background-color: #D6DBDF;">
            ...
            <div class="col-md-7 col-lg-8">
                ...
                <form class="needs-validation" novalidate name="altarecepcionista" method="post" action="php/AltaRecepcionista.php">
                    <div class="row g-3">
                        <!-- First name -->
                        <div class="col-sm-5">
                            <label for="firstName" class="form-label">Nombre</label>
                            <input type="text" class="form-control" id="firstName" name="nameEmpleado" placeholder="" value="" required>
