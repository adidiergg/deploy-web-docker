<?php
    ...
    $citas = new citas();
    $mostrar_datos = $citas->get_registro();
    $total_registros = $citas->paginacion();
...
<html lang="en">
    <head>
        ...
        <title>Recepcionista | Lista de citas</title>
    ...
    <body>
        ...
        <header>
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item active" href="consultasCita.php">Mostrar lista citas</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
            ...
            <div class="cover d-flex justify-content-end align-items-start p-5 flex-column" style="background-image: url(./img/fondThree.jpg);">
                ...
                <form action="consultasCitasI.php">
            ...
            ?>
                <div class="table-responsive">
                    ...
                    <thead class="table-dark">
                        <tr>
                        <th scope="col"><h5>Cód.Cita</h5></th>
