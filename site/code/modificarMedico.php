<?php
    ...
    $CURP = $_GET['id'];
    $medico = new medico();
    $actualizarDatos = $medico->search_registro($CURP);
...
<head>
    ...
    <title>Administrador | Actualizar medico</title>
...
<body>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="consultasMedico.php">Mostrar lista medicos</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <section class="container mt-5 mb-5">
        <div class="row g-5 mt-5" style="background-color: #EBEDEF;">
            <!-- Segundo formulario -->
            ...
            <div class="col-md-7 col-lg-8">
                ...
                <form class="needs-validation" novalidate name="modificar_medico" method="post" action="php/ModificarMedico.php">
                    <div class="row g-3">
                        <!-- Name -->
                        <div class="col-12">
                            <label for="firstName" class="form-label">Nombre</label>
                            <input type="text" class="form-control" id="firstName" name="nameMedico" value="<?php echo $dato['Nombre']; ?>" required>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="firstName" name="firstname" value="<?php echo $dato['First_name']; ?>" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="address" name="domicilio" value="<?php echo $dato['Domicilio']; ?>" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="text" style="text-transform: uppercase;" minlenght="18" maxlength="18" class="form-control" value="<?php echo $dato['CURP']; ?>" id="curp" disabled>
                            <div id="curp" class="form-text">Clave única de registro de población.</div>
                            <input type="hidden" name="curp" value="<?php echo $dato['CURP']; ?>">
                        </div>
                        <!-- Email -->
                         <div class="col-md-7">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="email" class="form-control" id="email" name="email" value="<?php echo $dato['Email']; ?>" required>
                            </div>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="tel" class="form-control" id="telefono" name="telefono" value="<?php echo $dato['Telefono_contacto']; ?>" required>
                            </div>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group has-validation">
                                <input type="number" min="18" max="110" name="edad" id="edad" class="form-control" value="<?php echo $dato['Edad']; ?>" required>
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-md-7">
                            ...
                            <select class="form-select" id="especialidad" name="especialidad" required>
                                ...
                                <?php
                                    foreach ($arrayesp as $row) {
                                        if ($row == $dato['Especialidad']) {
                                ?>
                                            <option value="<?php echo $row; ?>" selected><?php echo $row.'.'; ?></option>
                                <?php
                                        } else {
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="date" name="fechaContratacion" id="fechaContratacion" class="form-control" value="<?php echo $dato['Fecha_contratacion']; ?>" required>
                        </div>
                    </div>
                    <hr class="my-4">
