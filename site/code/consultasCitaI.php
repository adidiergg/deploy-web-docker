...
<head>
    ...
    <title>Recepcionista | Búsqueda de citas</title>
...
<body>
    ...
    <header>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item active" href="consultasCitaI.php">Búsqueda citas</a></li>
        ...
        <div class="cover d-flex justify-content-center align-items-center flex-column" style="background-image: url(./img/fondFire.jpg);">
            ...
            <form action="altasPacientes.php">
            ...
            <div class="d-flex bd-highlight mb-3">
                <div class="ms-auto p-2 bd-highlight">
                    <form class="d-flex" method="GET">
                        <input class="form-control me-2" type="search" name="busqueda" placeholder="Buscar cita" aria-label="Search" autocomplete="off" required>
            ...
            <div class="row justify-content-center">
                <?php
                    if (isset($_GET['enviar'])) {
                        ...
                        $mostrarBusqueda = $cita->search_registro($busqueda);
                        if ($mostrarBusqueda) {
                ?>
                            <div class="mt-3 mb-5">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['CURP_medico']; ?></td>
                                                            <td><?php echo $row['CURP_paciente']; ?></td>
                                                            <td><?php echo "<a class='btn btn-info' href='modificarCita.php?id=$Codigo'><i class='fa-solid fa-pen-to-square sizeSimbol'></i></a>" ?></td>
                                                            <td><?php echo "<a class='btn btn-danger' href='php/deleteCita.php?id=$Codigo'><i class='fa-solid fa-delete-left sizeSimbol'></i></a>" ?></td>
                                                        </tr>
                                                <?php
                                                    }
                                                ?>
