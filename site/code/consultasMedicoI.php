...
<head>
    ...
    <title>Administrador | Búsqueda de medicos</title>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item active" href="consultasMedicoI.php">Búsqueda medicos</a></li>
            ...
            <div class="d-flex bd-highlight mb-3">
                <div class="ms-auto p-2 bd-highlight">
                    <form class="d-flex" method="GET">
                        <input class="form-control me-2" type="search" name="busqueda" placeholder="Buscar médico" aria-label="Search" autocomplete="off" required>
            ...
            <div class="row justify-content-center">
                <?php
                    if (isset($_GET['enviar'])) {
                        ...
                        $mostrarBusqueda = $medico->search_registro($busqueda);
                        if ($mostrarBusqueda) {
                ?>
                            <div class="mt-3 mb-5">
