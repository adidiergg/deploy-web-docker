...
<head>
    ...
    <title>Recepcionista | Búsqueda de pacientes</title>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item active" href="consultasPacienteI.php">Búsqueda pacientes</a></li>
            ...
            <div class="d-flex bd-highlight mb-3">
                <div class="ms-auto p-2 bd-highlight">
                    <form class="d-flex" method="GET">
                        <input class="form-control me-2" type="search" name="busqueda" placeholder="Buscar paciente" aria-label="Search" autocomplete="off" required>
            ...
            <div class="row justify-content-center">
                <?php
                    if (isset($_GET['enviar'])) {
                        ...
                        $mostrarBusqueda = $paciente->search_registro($busqueda);
                        if ($mostrarBusqueda) {
                ?>
                            <div class="mt-3 mb-5">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $CURP;?></td>
                                                            <td><?php echo $row['Nombre'].' '.$row['Last_name']; ?></td>
                                                            <td><?php echo $row['Email']; ?></td>
                                                            <td><?php echo "<a class='btn btn-info' href='modificarPaciente.php?id=$CURP'><i class='fa-solid fa-pen-to-square sizeSimbol'></i></a>" ?></td>
                                                            <td><?php echo "<a class='btn btn-danger' href='php/deletePaciente.php?id=$CURP'><i class='fa-solid fa-delete-left sizeSimbol'></i></a>" ?></td>
                                                        </tr>
                                                <?php
                                                        $num++;
                                                    }
