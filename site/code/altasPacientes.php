                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item active" href="altasPacientes.php">Nuevo paciente</a></li>
    ...
    <section class="container mt-5 mb-5">
        <div class="row g-5 mt-5" style="background-color: #D6DBDF;">
            ...
            <div class="col-md-7 col-lg-8">
                ...
                <form class="needs-validation" novalidate name="altapaciente" method="post" action="php/AltaPaciente.php">
                    <div class="row g-3">
                        <!-- First name -->
                        <div class="col-sm-5">
                            <label for="firstName" class="form-label">Nombre</label>
                            <input type="text" class="form-control" id="firstName" name="namePaciente" placeholder="" value="" required>
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" style="text-transform: uppercase;" name="curp" minlenght="18" maxlength="18" class="form-control" id="email" placeholder="" autocomplete="off" required>
