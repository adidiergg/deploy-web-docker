<?php
    ...
    //Time array
    $horas = array(
        "09:00 a.m.", "09:20 a.m.", "09:40 a.m.",
        "10:00 a.m.", "10:20 a.m.", "10:40 a.m.",
        "11:00 a.m.", "11:20 a.m.", "11:40 a.m.",
        "12:00 p.m.", "12:20 p.m.", "12:40 p.m.",
        "13:00 p.m.", "13:20 p.m.", "13:40 p.m.",
        "14:00 p.m.", "14:20 p.m.", "14:40 p.m.",
        "15:00 p.m.", "15:20 p.m.", "15:40 p.m.",
        "16:00 p.m.", "16:20 p.m.", "16:40 p.m.",
        "17:00 p.m.", "17:20 p.m.", "17:40 p.m.",
        "18:00 p.m.", "18:20 p.m."
    );
...
<head>
    ...
    <title>Recepcionista | Nueva cita médica</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item active" href="altasCitas.php">Nueva cita medica</a></li>
                                <li><hr class="dropdown-divider"></li>
    ...
    <section class="container mt-5 mb-5">
        <div class="row g-5 mt-5" style="background-color: #D6DBDF;">
            ...
            <div class="col-md-8 col-lg-9">
                ...
                <form class="needs-validation" novalidate name="altacita" method="post" action="php/AltaCita.php">
                    <div class="row g-3">
                        <!-- Nombre-->
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="nombrePaciente" name="curp_paciente" required>
                                <option value="" class="form-text text-center" selected>Selecciona una opción</option>
                                <?php
