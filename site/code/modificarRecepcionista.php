<?php
    ...
    $actualizarDatos = $recepcionista->search_registro($CURP);
...
<head>
    ...
    <title>Administrador | Actualizar recepcionista</title>
    ...
    <section class="container mt-5 mb-5">
        <div class="row g-5 mt-5" style="background-color: #EBEDEF;">
            ...
            <div class="col-md-7 col-lg-8">
                ...
                <form class="needs-validation" novalidate name="modificar_recepcionista" method="post" action="php/ModificarRecepcionista.php">
                    <div class="row g-3">
                        <!-- Name -->
                        <div class="col-12">
                            <label for="firstName" class="form-label">Nombre completo</label>
                            <input type="text" class="form-control" id="firstName" name="nameEmpleado" value="<?php echo $dato['Nombre']; ?>" required>
