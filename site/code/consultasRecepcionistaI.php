...
<head>
    ...
    <title>Administrador | Búsqueda de Recepcionistas</title>
...
<body>
    ...
    <header>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item active" href="consultasRecepcionistaI.php">Búsqueda Recepcionistas</a></li>
        ...
        <div class="cover d-flex justify-content-center align-items-center flex-column" style="background-image: url(./img/fondNine.jpg);">
            ...
            <form action="altasRecepcionista.php">
            ...
            <div class="d-flex bd-highlight mb-3">
                <div class="ms-auto p-2 bd-highlight">
                    <form class="d-flex" method="GET">
                        <input class="form-control me-2" type="search" name="busqueda" placeholder="Buscar recepcionista" aria-label="Search" autocomplete="off" required>
            ...
            <div class="row justify-content-center">
                <?php
                    if (isset($_GET['enviar'])) {
                        ...
                        $mostrarBusqueda = $recepcionista->search_registro($busqueda);
                        if ($mostrarBusqueda) {
                ?>
                            <div class="mt-3 mb-5">
                                <div class="table-responsive">
                                        <table class="table table-striped table-hover table-light text-center">
                                            ...
                                            <tbody>
                                                <?php
                                                    $num = 1;
                                                    foreach ($mostrarBusqueda as $row) {
                                                        $CURP = $row['CURP'];
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo "<a class='btn btn-info' href='modificarRecepcionista.php?id=$CURP'><i class='fa-solid fa-pen-to-square sizeSimbol'></i></a>" ?></td>
                                                            <td><?php echo "<a class='btn btn-danger' href='php/deleteRecepcionista.php?id=$CURP'><i class='fa-solid fa-delete-left sizeSimbol'></i></a>" ?></td>
                                                        </tr>
                                                <?php
                                                        $num++;
                                                    }
                ...
                ?>
                            <div class="alert alert-danger d-flex align-items-center mt-3 col-11 col-md-9" role="alert">
                                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
                                <div>
                                    No se encontraron resultados coincidentes a la búsqueda.
                                </div>
                            </div>
                <?php
                        }
                ...
                ?>
                        <div class="alert alert-primary d-flex align-items-center mt-3 col-11 col-md-9" role="alert">
                            <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Info:"><use xlink:href="#info-fill"/></svg>
                            <div>
                                No se ha realizado una búsqueda por el momento.
                            </div>
                        </div>
                <?php
                    }
