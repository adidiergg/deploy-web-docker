<?php
    ...
    $mostrar_datos = $recepcionista->get_registro();
    $total_registros = $recepcionista->paginacion();
...
<html lang="en">
  <head>
    ...
    <title>Administrador | Lista de Recepcionistas</title>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item active" href="consultasRecepcionista.php">Mostrar lista Recepcionistas</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
