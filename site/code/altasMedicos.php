<?php
    require_once("php/connection.php");// el include es para llamar a un archivo
...
<head>
    ...
    <title>Administrador | Nuevo medico</title>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item active" href="altasMedicos.php">Nuevo medico</a></li>
    ...
    <section class="container mt-5 mb-5">
        <div class="row g-5 mt-5" style="background-color: #D6DBDF;">
            ...
            <div class="col-md-7 col-lg-8">
                ...
                <form class="needs-validation" novalidate name="altamedico" method="post" action="php/AltaMedico.php">
                    <div class="row g-3">
                        <!-- First name -->
                        <div class="col-sm-5">
                            <label for="firstName" class="form-label">Nombre</label>
                            <input type="text" class="form-control" id="firstName" name="nameMedico" placeholder="" value="" required>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="address" name="domicilio" placeholder="" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-7">
                            ...
                            <input type="text" style="text-transform: uppercase;" name="curp" minlenght="18" maxlength="18" class="form-control" id="email" placeholder="" autocomplete="off">
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="password" minlenght="8" maxlenght="35" class="form-control" name="password" id="contraseña" placeholder="" required autocomplete="off">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group has-validation">
                                <input type="number" min="18" max="110" name="edad" id="edad" class="form-control" required>
                                <span class="input-group-text">Años</span>
                            </div>
                            <div class="invalid-feedback">
                                Tú Edad es requerida.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="invalid-feedback">
                                Tú Fecha de contratación es requerida.
                            </div>
                        </div>
                    </div>
                    <hr class="my-4">
