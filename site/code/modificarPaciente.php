<?php
    require_once("php/paciente.php");// el include es para llamar a un archivo
    ...
    $actualizarDatos = $paciente->search_registro($CURP);
...
<head>
    ...
    <title>Recepcionista | Actualizar paciente</title>
...
<body>
    ...
    <header>
        ...
        <div class="cover d-flex justify-content-end align-items-start p-5 flex-column" style="background-image: url(img/fondSixe.jpg);">
            ...
            <p>El mejor servicio de atención medica.</p>
    ...
    <section class="container mt-5 mb-5">
        <div class="row g-5 mt-5" style="background-color: #D6DBDF;">
            ...
            <div class="col-md-7 col-lg-8">
                ...
                <form class="needs-validation" novalidate name="altapaciente" method="post" action="php/ModificarPaciente.php">
                    <div class="row g-3">
                        <!-- First name -->
                        <div class="col-sm-5">
                            <label for="firstName" class="form-label">Nombre</label>
                            <input type="text" class="form-control" id="firstName" name="namePaciente" value="<?php echo $dato['Nombre']; ?>" required>
                        ...
                        <div class="col-sm-7">
                            ...
                            <input type="text" class="form-control" id="lastName" name="firstName" value="<?php echo $dato['Last_name'];?>" required>
                            <div class="invalid-feedback">
                                El campo apellidos son requeridos.
                            </div>
                        </div>
                        <!-- CURP -->
                        <div class="col-md-9">
                            <label for="curp" class="form-label">CURP</label>
                            <input type="text" style="text-transform: uppercase;" name="curp" minlenght="18" maxlength="18" class="form-control" id="email" value="<?php echo $dato['CURP'];?>" disabled>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="sexo" name="sexo" required>
                                <option value="" class="text-center form-text" selected>Selecciona una opción</option>
                                <?php
